...
VALUES ('fbcef9848426e3a281d2b8d9e213ca80', 'someonecool', 'coty', 'dawson', 'coty.dawson@gmail.com', 'http://www.google.com/image.jpg', 'OFFLINE', 'NOT_READY', 28, 'United States');
INSERT INTO `partyrdb`.`partyr_users` ( `user_hash`, `user_name`, `first_name`, `last_name`, `email`, `profile_image_url`, `online_status`, `ready_to_play_status`, `age`, `country`)
